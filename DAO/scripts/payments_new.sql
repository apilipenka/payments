...
-- Дамп данных таблицы payments.commands: ~0 rows (приблизительно)
...
-- Дамп данных таблицы payments.currencies: ~0 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `exchange_rates` (
  ...
  KEY `fk_exchange_rates_Curremcies2` (`target_currency_id`),
  ...
  CONSTRAINT `fk_exchange_rates_Curremcies2` FOREIGN KEY (`target_currency_id`) REFERENCES `currencies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  CONSTRAINT `FK_users_user_roles` FOREIGN KEY (`user_role_id`) REFERENCES `user_roles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users` (`id`, `personal_number`, `first_name`, `last_name`, `birth_date`, `login`, `password`, `user_role_id`) VALUES
	(1, '122334433221', 'Alexander', 'Pilipenko', '1977-01-10', 'admin', '12345', 1),
	(2, '12213113', 'Dima', '&#1055;&#1080;&#1083;&#1080;&#1087;&#1077;&#1085;&#1082;&#1086;', '1976-06-14', 'manager', '123456', 1);
...
-- Дамп данных таблицы payments.user_roles: ~3 rows (приблизительно)
...
CREATE TABLE IF NOT EXISTS `user_role_commands` (
  ...
  CONSTRAINT `fk_Commands_has_Ueser_Roles_Ueser_Roles1` FOREIGN KEY (`ueser_role_id`) REFERENCES `user_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
